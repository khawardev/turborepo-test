        ...
        <div className="ml-4 mt-2 space-y-2">
          <Collapsible defaultOpen>
            ...
            <CollapsibleContent className="ml-4 mt-2 space-y-1">
              <Link
                href={`/me/brands/${brandId}`}
                className={cn(
                  "block text-muted-foreground hover:text-foreground",
                  pathname === `/me/brands/${brandId}` && "text-foreground",
                )}
              >
                /
              </Link>
              <Link
                href={`/me/brands/${brandId}/about`}
                className={cn(
                  "block text-muted-foreground hover:text-foreground",
                  pathname === `/me/brands/${brandId}/about` &&
                    "text-foreground",
                )}
              >
                /about
              ...
              <Link
                href={`/me/brands/${brandId}/contact`}
                className={cn(
                  "block text-muted-foreground hover:text-foreground",
                  pathname === `/me/brands/${brandId}/contact` &&
                    "text-foreground",
                )}
              >
                /contact
              ...
              <div key={competitor.competitor_id}>
                ...
                <div className="ml-4 mt-2 space-y-2">
                  <Collapsible>
                    ...
                    <CollapsibleContent className="ml-4 mt-2 space-y-1">
                      <Link
                        href={`/me/brands/${brandId}/competitors/${competitor.name}`}
                        className={cn(
                          "block text-muted-foreground hover:text-foreground",
                          pathname ===
                            `/me/brands/${brandId}/competitors/${competitor.name}` &&
                            "text-foreground",
                        )}
                      >
                        /
                      ...
                      <Link
                        href={`/me/brands/${brandId}/competitors/${competitor.name}/about`}
                        className={cn(
                          "block text-muted-foreground hover:text-foreground",
                          pathname ===
                            `/me/brands/${brandId}/competitors/${competitor.name}/about` &&
                            "text-foreground",
                        )}
                      >
                        /about
                      ...
                      <Link
                        href={`/me/brands/${brandId}/competitors/${competitor.name}/contact`}
                        className={cn(
                          "block text-muted-foreground hover:text-foreground",
                          pathname ===
                            `/me/brands/${brandId}/competitors/${competitor.name}/contact` &&
                            "text-foreground",
                        )}
                      >
                        /contact
