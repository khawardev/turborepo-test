...
export default function SocialDataView({ socialScrapedData }: any) {
    ...
    if (!socialScrapedData || !socialScrapedData.data.social_platforms || socialScrapedData.data.social_platforms.length === 0) {
        return <EmptyStateCard message="No social media data available for this selection." />
    }

    return (
        <div className="columns-1 md:columns-2  gap-6">
            {socialScrapedData.data.social_platforms.map((platformData: any) => (
