...
export default function BamExecution({ bam }: { bam: { id: string; name: string; executionMode: string } }) {
    const [mode, setMode] = useState<ExecutionMode>(bam.executionMode as ExecutionMode);
    ...
    const renderFinishedCard = () => (
        <Card>
            ...
            <CardContent>
                <p>The BAM execution has been finalized. You can download the final report.</p>
