...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "dark:bg-border/40 bg-accent  text-card-foreground flex flex-col gap-6 rounded-xl  py-6  border border-border ring-border/70 ring-offset-background ring-1 ring-offset-3",
