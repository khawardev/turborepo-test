...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
    return (
        <main
            ...
            className={cn(
                "relative flex border min-w-0 min-h-svh flex-1 flex-col bg-accent/50",
...
function SidebarMenu({ className, children, ...props }: React.ComponentProps<"ul">) {
    ...
    return (
        <ul
            ...
            data-sidebar="menu"
            className={cn(
                "flex w-full min-w-0 flex-col gap-1 relative",
        ...
        >
            <div
                className="absolute left-0 right-0 rounded-md bg-sidebar-accent z-0 transition-all duration-300 ease-out pointer-events-none"
                style={{
                    top: hoverStyle.top,
...
function SidebarMenuSubButton({
    ...
    return (
        <Comp
            ...
            data-active={isActive}
            className={cn(
                "flex h-9 mt-1 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 text-sidebar-foreground outline-none ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground",
